...
__DEFINE__(1667979542916, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1667979542917,"./event-store":1667979542918}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1667979542917, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1667979542918, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1667979542917,"./utils":1667979542919}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1667979542919, function(require, module, exports) {
...
return __REQUIRE__(1667979542916);
})()
